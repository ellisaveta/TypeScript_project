  ...
  transform(movie: MovieModel) {
    return {
      ...
      likedBy: movie.likedBy
        ? this.userTransformer.transformArray(movie.likedBy)
        : undefined,
      comments: movie.comments
        ? this.commentTransformer.transformArray(movie.comments)
        : undefined,
      reviews: movie.reviews
        ? this.reviewTransformer.transformArray(movie.reviews)
        : undefined,
    };
  }
