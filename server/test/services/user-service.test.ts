...
describe('UserService', () => {
    ...
    describe('#update', () => {
        it('updates user\'s name and password with valid id', async () => {
            ...
            await userService.update(registered.id, { name: 'Todor Tomov', password: 'philip123' });
        ...
        it('does not update anything when invalid id is passed', async () => {
            ...
            await userService.update(registered.id + 1, { name: 'Todor Tomov', password: 'philip123' });
    ...
    describe('#deleteById', () => {
        ...
        it('does not delete other users', async () => {
            ...
            const user = await UserModel.query().findOne({ email: 'philip2@mail.bg' });
